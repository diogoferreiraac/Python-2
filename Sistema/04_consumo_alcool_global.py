...
def grafico2():
    ...
    conn.close()
    # Criação dos dados e definição das colunas de segmentos e valores
...
def upload_avengers():
    ...
    return '''
        <h2> Uploado do arquivo do Avengers </h2>
...
def apagar_avengers():
    ...
    try:
        ...
        conn.commit()
        mensagem = "<h3>Tabela excluída com sucesso.</h3>"
...
def ver_avengers():
    ...
    if df_avengers.empty:
        return '<h2>Tabela vazia ou inexistente</h2>'
...
def atribui_pais():
    ...
    return "<h3>Países atribuídos com sucesso.</h3>"
